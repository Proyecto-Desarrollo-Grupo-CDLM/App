...
public class MundiFavsDomainSharedModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        MundiFavsGlobalFeatureConfigurator.Configure();
        MundiFavsModuleExtensionConfigurator.Configure();
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<MundiFavsDomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<MundiFavsResource>("es")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/MundiFavs");

            options.DefaultResourceType = typeof(MundiFavsResource);
        ...
        {
            options.MapCodeNamespace("MundiFavs", typeof(MundiFavsResource));
        });
    }
}
