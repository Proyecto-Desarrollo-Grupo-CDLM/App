...
public class MundiFavsHttpApiHostModule : AbpModule
{
    ...
    private void ConfigureVirtualFileSystem(ServiceConfigurationContext context)
    {
        ...
        if (hostingEnvironment.IsDevelopment())
        {
            ...
            {
                options.FileSets.ReplaceEmbeddedByPhysical<MundiFavsDomainSharedModule>(Path.Combine(hostingEnvironment.ContentRootPath, $"..{Path.DirectorySeparatorChar}MundiFavs.Domain.Shared"));
                options.FileSets.ReplaceEmbeddedByPhysical<MundiFavsDomainModule>(Path.Combine(hostingEnvironment.ContentRootPath, $"..{Path.DirectorySeparatorChar}MundiFavs.Domain"));
                options.FileSets.ReplaceEmbeddedByPhysical<MundiFavsApplicationContractsModule>(Path.Combine(hostingEnvironment.ContentRootPath, $"..{Path.DirectorySeparatorChar}MundiFavs.Application.Contracts"));
                options.FileSets.ReplaceEmbeddedByPhysical<MundiFavsApplicationModule>(Path.Combine(hostingEnvironment.ContentRootPath, $"..{Path.DirectorySeparatorChar}MundiFavs.Application"));
            });
        }
    }
