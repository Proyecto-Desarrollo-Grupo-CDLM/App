...
namespace MundiFavs.Migrations
{
    ...
    [Migration("20260218193458_MOdifico_Tabla_Eventos")]
    partial class MOdifico_Tabla_Eventos
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MundiFavs.Destinos.Destino", b =>
                {
                    b.OwnsOne("MundiFavs.Destinos.Coordenadas", "Ubicacion", b1 =>
                        {
            ...
            modelBuilder.Entity("MundiFavs.Eventos.Evento", b =>
                {
                    b.HasOne("MundiFavs.Destinos.Destino", null)
                        .WithMany()
                        .HasForeignKey("DestinoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
